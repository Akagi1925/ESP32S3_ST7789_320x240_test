...
//The pins are remapped to fit the usage of esp32s3 with st7789 320 x 240 tft lcd
//The program is modified by Thomas Fan (a.k.a Pinky) from Undergraduate CUHK
...
Adafruit_ST7789 tft = Adafruit_ST7789(42, 41, 47, 21, -1);// CS DC MOSI SCLK RST
...
//  delay(10);
  ...
  // initialize TFT
  tft.init(240, 320); // Init screen with 320 x 240 tft screen
  tft.setRotation(3);
